...
class EtudiantController extends AbstractController
{
    ...
    public function index(EtudiantRepository $etudiantRepository): Response
    {
        ...
        return $this->render('etudiant/index.html.twig', [
            'etudiants' => $etudiantRepository->findAll(["sexe" => 1])

        ]);
    }

    #[Route('/trier', name: 'app_etudiant_trier', methods: ['GET'   ,'POST'])]
    public function trier(EtudiantRepository $etudiantRepository,Request $request): Response
    {
